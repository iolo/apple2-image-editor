// Pixmap format:
//
// just a continuous byte stream.
// 1 byte per pixel.
//
// size = width * height
//
// ex. 4x6 pixmap = 4 * 6 = 24 bytes
// ex. 3x5 pixmap = 3 * 5 = 15 bytes

// TODO: support custom palettes
// based on VGA 256 color palette
...
export function init(width, height) {
  fbWidth = width;
  fbHeight = height;
  console.log(`Initialized pixmap framebuffer: ${width}x${height}`);
